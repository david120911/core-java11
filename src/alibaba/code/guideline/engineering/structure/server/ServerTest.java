package alibaba.code.guideline.engineering.structure.server;
...
public class ServerTest {
     ...
     * 服 务器端会因为处于 time_wait 的连接数太多，可能无法建立新的连接，
     * 所以需要在服务器上 调小此等待值。
     ...
     * 说明:主流操作系统的设计是将 TCP/UDP 连接采用与文件一样的方式去管理，
     * 即一个连接对 应于一个 fd。主流的 linux 服务器默认所支持最大 fd 数量为 1024，
     * 当并发连接数很大时很
